...
APPROACHING: Una vez el dron despega a 4 metros de altura, se le envía el comando para volar directamente al primer waypoint de nuestra lista. Calculo la distancia euclídea y, cuando el error es menor a 15 cm, considero que ha llegado a la zona y paso al modo de barrido.
...
RETURNING: He implementado un monitoreo simulado de batería. Si el nivel de batería desciende por debajo del 30%, el dron cambia automáticamente a este estado y se dirige a las coordenadas donde realizó el despegue para asegurar su retorno.
